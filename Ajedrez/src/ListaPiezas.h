...
public:
	...
	bool comprobar_movimiento(int origen_x, int origen_y, int destino_x, int destino_y, int turno, ListaPiezas L); // devuelve FALSE si el movimiento no se puede realizar
	...
	bool comprobar_jaque(int x, int y, int turno);
	bool comprobar_jaquemate(int turno, ListaPiezas L);
	bool comprobar_ahogado(int turno, ListaPiezas L);
