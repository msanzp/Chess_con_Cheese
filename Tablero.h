...
private:
        ...
        string Roque = "KQkq";   // Opciones de roque disponibles {"KQkq", "KQk", "KQq", "KQ", "Kkq", "Kk", "Kq", "K", "Qkq", "Qk", "Qq", "Q", "kq", "k", "q", "-"}
        string EnPassant = "";   // Posible posicion para jugada en passant (ejemplo: "e3")
...
public:
        ...
        void Tablero::Jugada();                                          // Función que realiza la jugada siguiente, sea por jugador o máquina
};
